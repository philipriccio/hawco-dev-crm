  ...
  return (
    <div className="space-y-3">
      <div className="space-y-2 max-h-72 overflow-auto pr-1">
        {initialCycles.length === 0 ? (
          ...
          initialCycles.map((cycle) => (
            <div key={cycle.id} className="p-3 rounded-lg bg-white/60 border border-amber-200">
      ...
      <div className="pt-3 border-t border-amber-200/60 space-y-2">
        ...
        <button onClick={handleAddCycle} disabled={isSaving} className="px-3 py-1.5 bg-amber-500 text-white rounded text-sm hover:bg-amber-600 disabled:opacity-50">
